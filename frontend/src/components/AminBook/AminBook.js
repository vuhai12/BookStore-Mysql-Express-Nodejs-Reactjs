...
import { fetchCreatNewBookToolkit, fetchDeleteNewBookToolkit, fetchGetListBookToolkit, fetchUpdateNewBookToolkit } from '../../redux/slides/bookSlice';
                    ...
                    <table className='w-full'>
                        <thead>
                            <tr >
                                ...
                                <th className="px-[5px] border-[1px]  border-gray-200 bg-gray-100 text-left text-[12px] font-semibold text-gray-600  ">Book</th>
                                ...
                                <th className="px-[5px] border-[1px]  border-gray-200 bg-gray-100 text-left text-[12px] font-semibold text-gray-600  " onClick={() => handleSort('available')}>
                                    <span>Available</span>
                                    {optionsFieldSort[1].sort_by == 'DESC' ? <FaSortDown /> : <FaSortUp />}
                                </th>
                                <th className="px-[5px] border-[1px]  border-gray-200 bg-gray-100 text-left text-[12px] font-semibold text-gray-600  " onClick={() => handleSort('category_code')}>
                                    <span>Category</span>
                                    {optionsFieldSort[2].sort_by == 'DESC' ? <FaSortDown /> : <FaSortUp />}
                                </th>
                                <th className="px-[5px] border-[1px]  border-gray-200 bg-gray-100 text-left text-[12px] font-semibold text-gray-600  " onClick={() => handleSort('price')}>
                                    <span>Price</span>
                                    {optionsFieldSort[3].sort_by == 'DESC' ? <FaSortDown /> : <FaSortUp />}
                                </th>
                                <th className="px-[5px] border-[1px]  border-gray-200 bg-gray-100 text-left text-[12px] font-semibold text-gray-600  " onClick={() => handleSort('description')}>
                                    <span>Description</span>
                                    {optionsFieldSort[4].sort_by == 'DESC' ? <FaSortDown /> : <FaSortUp />}
                                </th>
                                <th className="px-[5px] border-[1px]  border-gray-200 bg-gray-100 text-left text-[12px] font-semibold text-gray-600  " colSpan={3}>Action</th>
                            </tr>
                        </thead>
                        <tbody>
                            {listBook && listBook.length > 0 && listBook.map((item, idx) => {
                                return (
                                    <tr key={item.id}>
                                        ...
                                        <td className='px-[5px] border-[1px]  border-gray-200 bg-white text-[12px]'><img style={{ width: '50px', height: '50px' }} src={(item.image)}></img></td>
                                        <td className='px-[5px] border-[1px]  border-gray-200 bg-white text-[12px]'>{item.title}</td>
                                        <td className='px-[5px] border-[1px]  border-gray-200 bg-white text-[12px]'>{item.available}</td>
                                        <td className='px-[5px] border-[1px]  border-gray-200 bg-white text-[12px]'>{item.categoryData.value}</td>
                                        <td className='px-[5px] border-[1px]  border-gray-200 bg-white text-[12px]'>{item.price.toLocaleString()} VND</td>
                                        <td className='px-[5px] border-[1px]  border-gray-200 bg-white text-[12px]'>{item.description}</td>
